...
class IntegrationDataTests(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        importer.add_klasse("EAN", scope="EAN", facet_type_ref="org_unit_address_type")
        importer.add_klasse(
            "PhoneUnit", scope="PHONE", facet_type_ref="org_unit_address_type"
        )
        importer.import_all()
    ...
    def setUp(self):
        ...
        self.importer.add_organisation(
            identifier="Org", user_key="Org", municipality_code=101
        )
    ...
    def test_012_import_without_uuids(self):
        ...
        unit = self.morah._mo_lookup(
            "00000000-0000-0000-0000-000000000001", "ou/{}/integration-data"
        )
    ...
    def test_021_test_user_key_and_integration_data(self):
        ...
        engagement_list = self.morah.read_user_engagement(
            "00000000-0000-0000-1000-000000000000", at="2000-01-01"
        )
    ...
    def test_023_add_leave_to_user(self):
        ...
        print("Add leave!")
        self.importer.add_employee(
            name="Test user", identifier="Test user", cpr_no="1111111118"
        )
