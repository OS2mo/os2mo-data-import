...
settings = {
    ...
    "OS2SYNC_API_URL": top_settings[
        "os2sync.api_url"
    ],  # http://some-os2sync-url/api/v1_1",
    "OS2SYNC_CA_BUNDLE": top_settings["os2sync.ca_verify_os2sync"],
    "OS2SYNC_PHONE_SCOPE_CLASSES": top_settings[
        "os2sync.phone_scope_classes"
    ],  # can be empty
    "OS2SYNC_EMAIL_SCOPE_CLASSES": top_settings[
        "os2sync.email_scope_classes"
    ],  # can be empty
