...
from integrations.os2sync.os2mo import config, get_sts_user
...
mo_employee_it = [{'itsystem': {'name': 'OpenDesk',
                                'reference': None,
                                'system_type': None,
                                'user_key': 'OpenDesk',
...
def patched_session_get(url: str, params: Dict[Any, Any], **kwargs):
    ...
    for legal_end, value in {mo_employee_url_end: mo_employee,
