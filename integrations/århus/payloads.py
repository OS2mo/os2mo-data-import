...
def create_org_unit(
    *, uuid, user_key, name, parent_uuid, org_unit_type_uuid, from_date, to_date
):
    payload = {
        "type": "org_unit",
        "uuid": uuid,
...
def edit_org_unit(
    *, uuid, user_key, name, org_unit_type_uuid, parent_uuid, from_date, to_date
):
    payload = {
        "type": "org_unit",
        "uuid": uuid,
...
def create_it_rel(
    *, uuid, user_key, person_uuid, itsystem_uuid, from_date, to_date=None
):
    payload = {
        "type": "it",
        "uuid": uuid,
...
def edit_it_rel(*, uuid, user_key, person_uuid, itsystem_uuid, from_date, to_date=None):
    payload = {
        "type": "it",
        "uuid": uuid,
        "data": {
