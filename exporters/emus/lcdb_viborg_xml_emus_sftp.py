...
from exporters.emus.lcdb_viborg_xml_emus import config
from exporters.emus.lcdb_viborg_xml_emus import main as generate_file
...
def main():
    ...
    generate_file(emus_xml_file=generated_file, settings=config.settings)
